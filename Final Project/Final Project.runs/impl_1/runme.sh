...
HD_PWD='C:/Users/c3myb/OneDrive/Documents/VHDL/Final Project/Final Project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SerialControl_Basys3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SerialControl_Basys3.tcl -notrace
