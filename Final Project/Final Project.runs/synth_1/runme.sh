...
HD_PWD='C:/Users/c3myb/OneDrive/Documents/VHDL/Final Project/Final Project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SerialControl_Basys3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SerialControl_Basys3.tcl
